...
fw = {'db1', 'db2', 'db3', 'db4', 'db5', 'db6', 'db7', 'db8', 'sym2', 'sym3', 'sym4', 'sym5', 'sym6', 'sym7', 'sym8', ...
    'coif2', 'bior1.1', 'bior1.3', 'bior1.5', 'bior2.2', 'bior2.4', 'bior2.6'};
% fw = {'bior2.8', 'bior3.1', 'bior3.3', ...
%     'bior3.5', 'bior3.7', 'bior3.9', 'bior4.4', 'bior5.5', 'bior6.8', 'rbio1.1', 'rbio1.3', 'rbio1.5', 'rbio2.2', ...
%     'rbio2.4', 'rbio2.6', 'rbio2.8', 'rbio3.1', 'rbio3.3', 'rbio3.5', 'rbio3.7', 'rbio3.9', 
% fw = {'rbio4.4', 'rbio5.5', 'rbio6.8'};
...
for f = 1:length(lsc) % Wavelets madre
    ...
    for i = 1:length(audioCell) % Audios
        for z = 1:n + 1 % Coeficientes removidos
            ...
            pesq = medirPESQ(originalSignal, processedSignal) / 4.5;
