...
porcentajesRango = [0 1];  % Define el rango de los porcentajes aquí
mejorPesq = 0;  % Inicializa el mejor PESQ obtenido
mejorPorcentajes = zeros(1, 11);  % Inicializa los mejores porcentajes obtenidos

% Genera todas las combinaciones posibles de porcentajes dentro del rango especificado
combinaciones = combvec(porcentajesRango, porcentajesRango, porcentajesRango, ...
    porcentajesRango, porcentajesRango, porcentajesRango, porcentajesRango, ...
    porcentajesRango, porcentajesRango, porcentajesRango, porcentajesRango);



for i = 1:size(combinaciones, 2)
    porcentajes = combinaciones(:, i)';
     % Asigna los porcentajes al código actual
        porcentajesPercepcion = porcentajes;
...
% Imprime los mejores porcentajes y la mejor medida obtenida
disp("Mejores porcentajes:");
disp(mejorPorcentajes);
disp("Mejor PESQ obtenido:");
disp(mejorPesq);
