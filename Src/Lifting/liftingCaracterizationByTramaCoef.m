...
[x, Fs] = audioread('../../Grabaciones/Hombres/Juan David Romo/6. Juan Romo.m4a');
Ts = 1 / Fs;
...
mTotal = 0;
for i = 1:numTramas
    index = i * tramaSamples;
    %m1 = medirPESQ(xn(((i - 1) * tramaSamples) + 1:tramaSamples * i), senalReconst(((i - 1) * tramaSamples) + 1:tramaSamples * i)') / 4.5;
    m2 = medirNMSE(xn(((i - 1) * tramaSamples) + 1:tramaSamples * i), senalReconst(((i - 1) * tramaSamples) + 1:tramaSamples * i)');
    mTotal = mTotal + m2;
end
mTotal = mTotal / numTramas;
