...
addpath('../Grabaciones/');
addpath('../Mediciones/');
addpath('../Resultados/Comparacion/Reconstruccion');
...
for f = 1:length(lsc) % Wavelets madre
    ...
    disp("===============================================")
    save("../Resultados/Comparacion/Reconstruccion/" + algoritmo + "-Checkpoint.mat", "audioResults");
end
...
save("../Resultados/Comparacion/Reconstruccion/" + algoritmo + ".mat", "resultados");

% Carga los archivos de resultados
resultadosMallat = table2array(load('../Resultados/Comparacion/Reconstruccion/' + mallat + '.mat').resultados);
resultadosLifting = table2array(load('../Resultados/Comparacion/Reconstruccion/' + lifting + '.mat').resultados);
